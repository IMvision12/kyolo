"""Convert an official YOLOv8 PyTorch checkpoint into kyolo Keras 3 weights.
...
from .yolov8_model import build_yolov8
...
def convert(
    ...
    """Build a YOLOv8 model and transfer weights from ``weights_path``."""
    model = build_yolov8(variant=variant, nc=nc, input_shape=(imgsz, imgsz, 3), deploy=True)
...
def main():
    ...
    p = argparse.ArgumentParser(description="Convert YOLOv8 .pt -> kyolo .weights.h5")
