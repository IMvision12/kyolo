"""Convert an official YOLO26 PyTorch checkpoint into kyolo Keras 3 weights.
...
Usage::
    ...
    python -m kyolo.models.yolo26.convert_yolo26_torch_to_keras \
        --weights yolo26n.pt --output yolo26n.weights.h5 --variant 'n'
"""
...
from .yolo26_model import build_yolo26
...
def convert(
    ...
    """Build a YOLO26 model and transfer weights from ``weights_path``."""
    model = build_yolo26(variant=variant, nc=nc, input_shape=(imgsz, imgsz, 3), deploy=True)
...
def main():
    ...
    p = argparse.ArgumentParser(description="Convert YOLO26 .pt -> kyolo .weights.h5")
