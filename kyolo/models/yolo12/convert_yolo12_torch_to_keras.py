"""Convert an official YOLO12 PyTorch checkpoint into kyolo Keras 3 weights.
...
Usage::
    ...
    python -m kyolo.models.yolo12.convert_yolo12_torch_to_keras \
        --weights yolo12n.pt --output yolo12n.weights.h5 --variant 'n'
"""
...
from .yolo12_model import build_yolo12
...
def main():
    ...
    p = argparse.ArgumentParser(description="Convert YOLO12 .pt -> kyolo .weights.h5")
