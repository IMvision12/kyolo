...
def build_yolov9(
    variant="c", nc=80, input_shape=(640, 640, 3), data_format="channels_last",
    ...
    def gelan(x, c2, c3, c4, name):
        return rep_ncspelan4(x, ch(c2), ch(c3), ch(c4), n=1, deploy=deploy,
...
def YOLOv9(variant="c", nc=80, input_shape=(640, 640, 3), data_format="channels_last", deploy=True, **kwargs):
